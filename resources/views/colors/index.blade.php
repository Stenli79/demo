                                ...
                                @foreach($colors as $color)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <form id="form-destroy-slot" method="POST" action="{{ route('color.destroy', ['color' => $color->id]) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                            </form>
                                            <a href="{{ route('color.destroy', ['color' => $color->id]) }}" class="btn-green text-6 ml-1 ml-sm-2 submit-previous-form" data-toggle="tooltip" data-original-title="{{ __('messages.table_destroy_action_label') }}">
