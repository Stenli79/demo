...
@section('title', __('messages.color_create_page_title'))
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-6 col-lg-8">{{ __('messages.color_create_header') }}</div>
                ...
                <div class="card-body container-fluid col-xs-2 col-lg-10">
                    ...
                    =============================== -->
                        ...
                        <form id="form-create-color" method="POST" action="{{ route('color.store') }}">
                            @csrf
                            ...
                            @include('shared.color-picker', ['value' => null])
                            <hr>
