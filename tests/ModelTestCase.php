...
abstract class ModelTestCase extends TestCase
{
    ...
    {
        $this->assertEquals($fillable, $model->getFillable(), 'Fillable not mutch');
        $this->assertEquals($hidden, $model->getHidden(), 'Hidden not mutch');
        $this->assertEquals($guarded, $model->getGuarded(), 'Guarded not mutch');
        $this->assertEquals($visible, $model->getVisible(), 'Visible not mutch');
        $this->assertEquals($casts, $model->getCasts(), 'Casts not mutch');
        $this->assertEquals($dates, $model->getDates(), 'Dates not mutch');
        $this->assertEquals($primaryKey, $model->getKeyName(), 'Primary key not mutch');
